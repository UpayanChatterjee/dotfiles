...
hl.gesture({ fingers = vars.gestureFingers, direction = "down", action = function()
    hl.exec_cmd("caelestia-toggle specialws")
end })
hl.gesture({ fingers = vars.gestureFingersMore, direction = "up", action = function()
    hl.exec_cmd("qs ipc -c overview call overview toggle")
end })
hl.gesture({ fingers = vars.gestureFingersMore, direction = "down", action = function()
    hl.exec_cmd("qs ipc -c overview call overview toggle")
end })
